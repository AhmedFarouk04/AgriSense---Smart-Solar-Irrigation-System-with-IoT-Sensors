...
export const AgriSenseLogo = ({ size = 44, animate = false }: LogoProps) => {
  ...
  return (
    ...
    >
      ...
      <path
        d="M95 48 C74 66 60 96 67 124 C73 148 95 156 113 140 C131 124 132 92 116 66 C107 50 100 44 95 48Z"
        fill={`url(#lg-leaf-${uid})`}
        filter={`url(#glow-leaf-${uid})`}
      />
      <path
      ...
      <path
        d="M100 86 C100 86 74 118 74 136 C74 151 86 163 100 163 C114 163 126 151 126 136 C126 118 100 86 100 86Z"
        fill={`url(#lg-drop-${uid})`}
        filter={`url(#glow-drop-${uid})`}
      />
      <ellipse
        cx="92"
        cy="118"
